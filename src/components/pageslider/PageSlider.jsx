    ...
    const renderPageNumbers = () => {
        ...
        return pages.map((p) => (
            <button
                ...
                className={`w-[40px] text-[15px] mx-1 flex justify-center items-center p-2 rounded-full font-bold ${page === p ? 'bg-[#FF6300] text-[#2B2A3C] cursor-default' : 'bg-[#2B2A3C]  text-[#999] hover:text-[#FF6300]'} ${start ? "bg-[#353537]" : "bg-[#2B2A3C]"} `}
            >
                {p}
            </button>
        ));
