      ...
      <div className={`w-full ${className}`}>
        <div className="flex items-center justify-between">
          ...
          {showViewMore && (
            ...
            >
              <p className="text-white text-[12px] font-semibold h-fit leading-0 group-hover:text-[#FF6300] transition-all ease-out">
                View more
              </p>
            ...
            >
              {itemsToRender.firstRow.map((item, index) => (
                ...
                >
                  ...
                  <Link
                    to={`/${item.id}`}
                    className="text-white font-semibold mt-1 item-title hover:text-[#FF6300] hover:cursor-pointer line-clamp-1"
                  >
